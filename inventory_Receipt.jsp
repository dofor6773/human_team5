...
<body>
    <div class="container">
        <header>
            <nav>
            	<a href="#">로그인</a>
                <a href="./product_management.jsp">제품관리</a>
                <a href="./em_input.html">사원관리</a>
                <a href="./inventory_Receipt.jsp">입고관리</a>
            </nav>
            <h1>입고관리</h1>
            <p>
        ...
        <form id="productForm"  method="POST">
            ...
            <!--공급업체 찾기 버튼 추가-->
            <button type="button" onclick="openSupplierSearch()">찾기</button>
            ...
            <!--창고 위치 찾기 버튼 추가-->
            <button type="button" onclick="openWarehouseSearch()">찾기</button>
